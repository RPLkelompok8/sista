...
class mypanelpage extends mypanel{	
	...
	public function contentdashboard($logostatusTA1){
	echo '<div class="row col-no-gutter-container">
				...
				<div class="col-xs-12 col-md-6 col-lg-3 col-no-gutter">
					<div class="panel panel-orange panel-widget">
						<div class="row no-padding">
							<div class="col-sm-3 col-lg-5 widget-left">
								<em class="glyphicon '.$logostatusTA1.' glyphicon-l"></em>
							</div>
							<div class="col-sm-9 col-lg-7 widget-right">
		...
		if(parent::$uploadedta==0){
			$isi.='
							<form role="form" enctype="multipart/form-data" method="post">							
								...
								<div class="form-group" id="divinputfileTA">
									<label>Berkas</label>
									<input type="file" name="fileTA" id="fileTA" onchange="checkfile(\'divinputfileTA\', \'fileTA\', \'10240000\');" required/>
									<p class="help-block" id="loaded_n_total">File harus ber-format ".pdf" & max size 10Mb</p>
								</div>								
			...
			$isi.='
							...
							<button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-trash"></span> &nbsp;Delete</button>
							<button class="btn btn-default margin" type="button"><span class="glyphicon glyphicon-edit"></span> &nbsp;Edit</button>';
		}							
							$isi.='</div>
						</div>
					</div>
